...
export function questionsMaker(props){
    return ([
        ...
        {
            id: 3,
            title: 'جریمه اضافه بار در پرواز شیراز تهران چقدر است؟',
        ...
        {
            id: 4,
            title: 'جریمه کنسلی (استرداد) بلیط هواپیمای شیراز تهران چقدر است؟',
            description: 'درباره میزان جریمه کنسلی بلیط شیراز به تهران نمی‌توان یک عدد ثابت مطرح کرد؛ بنابراین بهتر است هنگام انتخاب بلیط در علی بابا روی قوانین استرداد کلیک و محتوای آن را مطالعه کنید.'
        },
        {
            id: 5,
            title: 'برای خرید بلیط هواپیما شیراز تهران ارزان چه باید کرد؟',
        ...
        {
            id: 6,
            title: 'چه طور می‌توانم بلیط چارتر شیراز تهران را بخرم؟',
            description: 'با انتخاب شیراز و تهران سفر و جستجو در علی بابا، لیست بلیط‌های موجود را خواهید دید. حالا در پنجره «نوع بلیط» در کنار صفحه گزینه چارتر را انتخاب کنید تا در صورت موجود بودن، تنها پروازهای چارتر را ببینید.'
        },
        {
            id: 7,
            title: 'لیست قیمت بلیط هواپیما شیراز تهران را چه طور پیدا کنیم؟',
            description: 'کافی است در علی بابا مبدا را شیراز و مقصد را تهران تعیین و روی جستجو کلیک کنید. در این زمان لیست قیمت بلیط‌های موجود را مشاهده خوهید کرد. همچنین می‌توانید هتل های تهران را از علی بابا رزرو کنید.'
        }
    ]

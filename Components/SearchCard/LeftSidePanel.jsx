    ...
    return(
        <Box sx={{
            ...
            <Box sx={{display:'flex', flexDirection:'row',alignItems: 'center'}}>
                <Typography sx={{fontFamily: 'AliBaba', color: theme.palette.secondary.four, fontSize: '20px', fontWeight:'700'}}>8811000</Typography>
            ...
            <Typography sx={{fontFamily: 'AliBaba', color: theme.palette.danger.four, fontSize: '12px', fontWeight:'400'}}>3 صندلی باقیمانده</Typography>
        </Box>
    )
}